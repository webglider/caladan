...
int main(int argc, char *argv[]) {
  ...
  str_to_netaddr("192.168.11.122:8001", &peer_addr[2]);
  str_to_netaddr("192.168.11.123:8001", &peer_addr[3]);
  str_to_netaddr("192.168.11.124:8001", &peer_addr[4]);
  str_to_netaddr("192.168.11.125:8001", &peer_addr[5]);
